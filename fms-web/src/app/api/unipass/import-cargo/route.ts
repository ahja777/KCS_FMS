...
const SIMULATION_DATA: UnipassImportCargoResult[] = [
  // 유니패스 실제 데이터 기반 (2022년) - SMLMVAN2A0923400 / 22SMLM0114I-0002
  {
    cargoMgtNo: '22SMLM0114I-0002',
    mblNo: 'SMLMVAN2A0923400',
    hblNo: '-',
    mrn: '03D10350870221027736',
    msn: '001',
    hsn: '01',
    receiptDt: '2022-08-18',
    arrivalDt: '2022-08-02',
    cargoStatus: '반출완료',
    processStatus: '수입신고수리',
    containerNo: 'SMLM4320115',
    cargoType: 'FCL',
    packageQty: 4032,
    grossWeight: 120960,
    cbm: 85.5,
    shipperNm: 'SHANGHAI MEILONG FOODS CO., LTD',
    consigneeNm: '(주)보성신항물류',
    customsOffice: '부산세관관세사무소',
    bondedArea: '보성신항물류(주)'
  },
  {
    cargoMgtNo: '22SMLM0114I-0001',
    mblNo: 'SMLMVAN2A0923400',
    hblNo: '-',
    mrn: '03D10350870221027735',
    msn: '001',
    hsn: '02',
    receiptDt: '2022-08-17',
    arrivalDt: '2022-08-02',
    cargoStatus: '반출완료',
    processStatus: '수입신고수리',
    containerNo: 'SMLM4320116',
    cargoType: 'FCL',
    packageQty: 2500,
    grossWeight: 75000,
    cbm: 52.3,
  ...
  {
    cargoMgtNo: '22SMLM0114I-0003',
    mblNo: 'SMLMVAN2A0923400',
    hblNo: '-',
    mrn: '03D10350870221027737',
    msn: '001',
    hsn: '03',
    receiptDt: '2022-08-19',
    arrivalDt: '2022-08-02',
    cargoStatus: '반출완료',
    processStatus: '수입신고수리',
    containerNo: 'SMLM4320117',
    cargoType: 'FCL',
    packageQty: 1800,
    grossWeight: 54000,
    cbm: 38.2,
