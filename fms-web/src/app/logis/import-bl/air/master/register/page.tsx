...
function RegisterContent() {
  ...
  const handleConfirmClose = useCallback(() => {
    ...
    router.push('/logis/import-bl/air/master');
  }, [router]);
          ...
          <div className="card p-6 mb-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 bg-[var(--surface-50)] border border-[var(--border)] rounded-lg" placeholder="Master AWB 번호" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1 text-[var(--muted)]">항공사</label>
                <input type="text" className="w-full px-3 py-2 bg-[var(--surface-50)] border border-[var(--border)] rounded-lg" placeholder="항공사" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 bg-[var(--surface-50)] border border-[var(--border)] rounded-lg" placeholder="편명" />
              </div>
            </div>
          </div>
          ...
          <div className="card p-6 mb-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div>
                ...
                <input type="text" className="w-full px-3 py-2 bg-[var(--surface-50)] border border-[var(--border)] rounded-lg" placeholder="DEP" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1 text-[var(--muted)]">도착공항</label>
                <input type="text" className="w-full px-3 py-2 bg-[var(--surface-50)] border border-[var(--border)] rounded-lg" placeholder="ARR" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1 text-[var(--muted)]">HAWB Count</label>
                <input type="number" className="w-full px-3 py-2 bg-[var(--surface-50)] border border-[var(--border)] rounded-lg" placeholder="0" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1 text-[var(--muted)]">Total Weight (kg)</label>
                <input type="number" step="0.01" className="w-full px-3 py-2 bg-[var(--surface-50)] border border-[var(--border)] rounded-lg" placeholder="0" />
              </div>
            </div>
          </div>
