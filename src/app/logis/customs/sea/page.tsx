...
export default function CustomsListPage() {
  ...
  const handleEdit = () => {
    ...
    router.push(`/logis/customs/sea/register?id=${id}`);
  };
  ...
  return (
        ...
        <main ref={formRef} className="p-6">
          <div className="flex justify-between items-center mb-6">
            <button onClick={() => router.push('/logis/customs/sea/register')} className="px-4 py-2 bg-[var(--surface-100)] border border-[var(--border)] rounded-lg hover:bg-[var(--surface-200)] text-sm">신규</button>
